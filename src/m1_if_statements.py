...
def display_rating(rating):
    if rating >= 5:
        print(f"Congratulations you got a score of {rating}")
    elif rating >= 4:
        print(f"Good job! You got a score of {rating}")
    elif rating >= 3:
        print(f"Nice try! You got a score of {rating}")
    elif rating >= 2:
        print(f"You got a score of {rating}, a good attempt!")
    elif rating >= 1:
        print(f"You got a score of {rating}, you will do better next time!")
display_rating(5.5)